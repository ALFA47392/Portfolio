                ...
                <div style="flex: 1; min-width: 300px;">
                    ...
                    <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
                        ...
                        <a href="https://www.linkedin.com/in/flavien-alcazar/" target="_blank" style="text-decoration: none;">
                            <div class="badge" style="background: #0077b5; color: #fff; padding: 0.8rem 1.5rem; font-size: 0.9rem; cursor: pointer; transition: 0.3s;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'">
                                LinkedIn
                            </div>
                        </a>
                        <a href="https://github.com/ALFA47392" target="_blank" style="text-decoration: none;">
                            <div class="badge" style="background: var(--card); color: var(--text); padding: 0.8rem 1.5rem; font-size: 0.9rem; cursor: pointer; transition: 0.3s; border: 1px solid var(--border);" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'">
                                GitHub
                            </div>
                        </a>
                    </div>
